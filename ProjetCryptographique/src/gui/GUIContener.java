 ...
 * @author Axel
 */
public class GUIContener extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        titre.setText("<html><h1>Dyari</h1></html>");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIContener.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUIContener().setVisible(true);
            }
        });
    }
